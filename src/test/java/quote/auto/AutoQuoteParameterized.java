...
public class AutoQuoteParameterized extends TestBase {
	...
	public void AutoQuoteParameterized(String title, String zip1, String zip2g) throws InterruptedException {
		...
		// Thread.sleep(5000);
		// homePage.verifySubTitleText("To ensure you receive the best service
		// possible,<br>please enter your zip code below:");
		homePage.zipCodeTest();
		homePage.submitZipCodeButtonTest();
		// homePage.errorMsgTextTest("Please enter a valid ZIP code so we can direct you
		// to the<br>AAA website in your area.");
		// homePage.footerTextTest("AAA Northeast serves members in CT, MA, NH, NJ, NY &
		// RI.");
