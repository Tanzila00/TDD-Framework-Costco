...
public class AutoQuoteTest extends TestBase {
	...
	public void getAutoQuoteTest() throws InterruptedException {
		...
		// Thread.sleep(5000);
		homePage.verifySubTitleText(
				"To ensure you receive the best service possible,<br>please enter your zip code below:");
		// Thread.sleep(5000);
		homePage.zipCodeTest();
		// Thread.sleep(5000);
		homePage.submitZipCodeButtonTest();
		// Thread.sleep(500);
		homePage.errorMsgTextTest(
				"Please enter a valid ZIP code so we can direct you to the<br>AAA website in your area.");
